    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link
            href="/login"
            className="hidden sm:inline-flex items-center justify-center rounded-full hover:bg-orange-600 px-5 py-2 text-sm font-medium text-white bg-orange-500 transition"
          >
            Login
          </Link>
        </div>
